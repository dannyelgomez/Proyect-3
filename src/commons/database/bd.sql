...
INSERT INTO
  users
VALUES
  (NULL,"tom","tom123","Tom Warner","guido732@gmail.com",1122223333,"Calle Falsa 123",TRUE,FALSE),
  (NULL,"jerry","jerry123","Thom Yorke","thom@radiohead.com",1199998888,"Kulas Light Apt.556",FALSE,FALSE),
  (NULL,"cbarnett","mundanemonday","Courtney Barnett","courtney@gmail.com",0106926593,"Victor Plains Suite 879",FALSE,FALSE);
